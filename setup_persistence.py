...
__project_title__ = "evoml-python-commons-persistence"
__project_name__ = "evoml-python-commons-persistence"
__package_name__ = "evoml_python_commons_persistence"
...
requirements = get_requirements(file_path=setup_path.joinpath("requirements_persistence.txt"))
