...
__project_title__ = "evoml-python-commons-data"
__project_name__ = "evoml-python-commons-data"
__package_name__ = "evoml_python_commons_data"
...
requirements = get_requirements(file_path=setup_path.joinpath("requirements_data.txt"))
